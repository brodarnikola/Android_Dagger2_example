...
class RegistrationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // na taj nacin smo popunili fieldove koje je zahtijevala RegistrationActivity, koji su oznaceni sa @Inject anotacijom
        // to se pise prije super.onCreate(savedInstanceState) da se izbjegnu problemi s fragment restoration ( obnovom )
